...
| ゲスト閲覧 | 整合化済み | 公開ジム、イベントはゲスト閲覧可。予定、記録、投稿、保存、参加、作成、コメント、設定はログイン必須 |
...
- 設計文書の古い「/home以降ログイン必須」を、現方針の「ジム/イベントはゲスト閲覧可、活動データと操作はログイン必須」へ更新した。
...
- ゲスト閲覧を第一導線にし、ジム/イベント以外の予定・記録・投稿・保存・参加・作成・コメント時にログイン誘導する。
