export const openApiDocument = {
  ...
  paths: {
    ...
    "/admin/events": { get: operation("admin", "List admin events", "EventListResponse") },
    "/admin/announcements": { get: operation("admin", "List admin announcements", "AnnouncementListResponse") },
