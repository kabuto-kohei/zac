export const openApiDocument = {
  ...
  paths: {
    ...
    "/me/profile": {
      get: operation("me", "Get current user profile", "CurrentProfileResponse"),
      put: operation("me", "Upsert current user profile", "UserProfileResponse", [], "OnboardingProfileInput"),
    },
    "/me/settings": { patch: operation("me", "Update current user settings", "CurrentProfileResponse", [], "UpdateProfileSettingsInput") },
    ...
    "/admin/users": { get: operation("admin", "List users", "AdminUserListResponse") },
    "/admin/events": {
      get: operation("admin", "List admin events", "EventListResponse"),
      post: operation("admin", "Create admin event", "EventResponse", [], "UpsertAdminEventInput"),
    },
    "/admin/events/{eventId}": { patch: operation("admin", "Update admin event", "EventResponse", ["eventId"], "UpsertAdminEventInput") },
    "/admin/announcements": {
      get: operation("admin", "List admin announcements", "AnnouncementListResponse"),
      post: operation("admin", "Create admin announcement", "AnnouncementResponse", [], "UpsertAdminAnnouncementInput"),
    },
    "/admin/announcements/{announcementId}": { patch: operation("admin", "Update admin announcement", "AnnouncementResponse", ["announcementId"], "UpsertAdminAnnouncementInput") },
  ...
  components: {
    ...
    schemas: {
      ...
      Event: object({ id: string(), title: string(), description: string(), gymName: string(), startsAt: string(), endsAt: string(), capacity: string(), status: string() }, ["id", "title", "description", "gymName", "startsAt", "endsAt", "capacity", "status"]),
      ...
      Announcement: object({ id: string(), title: string(), body: string(), audience: string(), status: string(), publishedAt: string() }, ["id", "title", "body", "audience", "status", "publishedAt"]),
      ...
      UserProfile: object({ userId: string(), email: nullableString(), displayName: string(), discipline: string(), experience: string(), area: string(), defaultVisibility: string(), locationEnabled: bool() }, ["userId", "email", "displayName", "discipline", "experience", "area", "defaultVisibility", "locationEnabled"]),
      AdminUser: object({ id: string(), email: string(), displayName: string(), status: string(), area: string(), createdAt: string() }, ["id", "email", "displayName", "status", "area", "createdAt"]),
      FeedEntry: object({ type: string(), item: {} }, ["type", "item"]),
      OnboardingProfileInput: object({ displayName: string(), discipline: string(), experience: string(), area: string(), interest: string(), defaultVisibility: string(), locationEnabled: bool() }, ["displayName", "discipline", "experience", "area", "interest", "locationEnabled"]),
      UpdateProfileSettingsInput: object({ defaultVisibility: string(), locationEnabled: bool() }, ["defaultVisibility", "locationEnabled"]),
      ...
      UpsertAdminEventInput: object({ title: string(), gymId: nullableString(), description: nullableString(), startsAt: string(), endsAt: nullableString(), status: string() }, ["title", "startsAt"]),
      UpsertAdminAnnouncementInput: object({ title: string(), body: string(), status: string() }, ["title", "body"]),
      ...
      UserProfileResponse: dataRef("UserProfile"),
      CurrentProfileResponse: data({ oneOf: [ref("UserProfile"), { type: "null" }] }),
      ...
      AdminUserListResponse: paginatedArray("AdminUser"),
